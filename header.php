...
<header class="uc-header">
  ...
  <nav class="uc-navbar">
    ...
    <div class="container d-none d-lg-block">
      <div class="row">
        <div class="col-lg-6">
          <img src="https://dummyimage.com/700x100/edeaed/0076de.png" alt="Logo de Facultad" class="img-fluid">
        </div>
      </div>
...
<header class="uc-header">
  ...
  <nav class="uc-navbar navbar-dark">
    <div class="container d-none d-lg-block">
      <div class="row">
        <div class="col-lg-6">
          <img src="https://dummyimage.com/700x100/edeaed/0076de.png" alt="Logo" class="img-fluid">
        </div>
      </div>
      <ul class="uc-navbar_nav">
        <li class="nav-item">

  ...
  <div class="uc-navbar_mobile d-block d-lg-none">
    ...
    <div class="uc-navbar_mobile-content" data-toggle="collapseMobileNav" data-open="false" style="height: 0;">
      <div class="uc-navbar_mobile-list">
        <a href="#" class="list-item">Texto</a>
        <a href="#" class="list-item">Texto</a>
        <a href="#" class="list-item">Texto</a>
        <a href="#" class="list-item">Texto</a>
      </div>
...
<div class="uc-navbar">
  <div class="container d-none d-lg-block">
    <div class="row align-items-center">
      <div class="col-lg-2">
        <img src="logo-uc-color.svg" alt="Logo de Facultad">
      </div>
      <div class="col-lg-9">
...
<div class="uc-navbar navbar-dark mt-80">
  <div class="container d-none d-lg-block">
    <div class="row align-items-center">
      <div class="col-lg-2">
        <img src="logo-blanco.svg" alt="Logo de Facultad" class="img-fluid">
      </div>
      <div class="col-lg-9">

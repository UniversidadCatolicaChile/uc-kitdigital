...
<div class="container">
    ...
    <div class="mt-60">
        <div class="uc-carousel-cards"
             ...
             data-prev-button=".carousel-controls .prev"
             data-next-button=".carousel-controls .next"
             data-counter="true"
             data-track="true">
                    ...
                    <div class="uc-card card-bg--image card-gradient--bottom-blue" style="background-image: url('img/card_1.jpg')">
                        <div class="uc-card_body">
                            ...
                            <div class="uc-card mt-auto">
                                <div class="uc-card_body">
                                    <p class="p-size--sm p-color--gray p-text--condensed mb-12">18 Marzo 2018</p>
            ...
            <div class="carousel-controls d-none d-lg-flex">
                <div class="prev">
...
<div class="uc-carousel mb-80"
    ...
    <div class="uc-hero-carousel">
        <div class="hero-carousel_item uc-card card-bg--image card-gradient--top-black card-radius--none card-border--none" style="background-image: url('img/slider_1.jpg')"></div>
...
<div class="container my-60">
    <div class="uc-carousel-cards"
         ...
         data-prev-button=".events-controls .prev"

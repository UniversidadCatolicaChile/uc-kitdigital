...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-4">
      <div class="uc-card">
        <img src="https://via.placeholder.com/300x190" class="img-fluid" alt="">
  ...
  <div class="row my-36">
    <div class="col-lg-6">
      <div class="uc-card card-type--horizontal">
        <img src="https://via.placeholder.com/200x160" class="img-fluid" alt="">
        <div class="uc-card_body">
          <a href="#" class="uc-tag">
            Texto
          </a>
  ...
  <div class="row my-36">
    <div class="col-md-2">
      <div class="uc-card card-border--bottom">
    ...
    <div class="col-lg-2">
      <a href="#" class="uc-card card-border--bottom">
        <div class="uc-card_body text-center">
          <div class="uc-icon icon-size--xl">local_library</div>
    ...
    <div class="col-md-4">
      <form action="">
        <div class="uc-form-group uc-radio-group">
          <input type="radio" id="switch_1" name="switch" value="si" class="uc-orig-radio" checked/>
      ...
      <div class="uc-collapse uc-card">
        ...
        <div class="uc-collapse_body">
          <table class="uc-table">
            <tbody>
            <tr>
              <td style="width: 120px;"><strong>9:00 - 9:30</strong></td>
              <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</td>
            </tr>
            <tr>
              <td><strong>9:00 - 9:30</strong></td>
      ...
      <div class="col-md-6">
        <div class="uc-card">
          <div class="uc-card_body--xl">
            ...
            <p class="no-margin"><strong>Alexis Calergis</strong></p>
            <p class="gray no-margin">Director Instituto Milenio en Inmunología e Inmunoterapia</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-5 order-last order-md-first">
        <div class="uc-card">
          <div class="uc-card_body--xl">
            ...
            <p class="no-margin"><strong>Alexis Calergis</strong></p>
            <p class="text-color--gray no-margin">Director Instituto Milenio en Inmunología e Inmunoterapia</p>
          </div>
        </div>
      </div>
      <div class="col-md-7">
